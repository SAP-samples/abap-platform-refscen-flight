...
- `/DMO/FLIGHT_REC` - Contains the development objects showcasing RAP recommendations. In the scenario, a destination for a travel description is suggested using an AI-enhanced approach, and accommodations are suggested for the destination using a deterministic approach (see [Adding RAP Recommendations](https://help.sap.com/docs/abap-cloud/abap-rap/recommendations)).
